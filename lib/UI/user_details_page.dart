  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(
          provider.userData.fullName != null
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child: FieldTemplate(
                  fieldName: 'Gender',
                  fieldData: provider.userData.gender != null
              ...
              Container(
                ...
                child: FieldTemplate(
                  ...
                  fieldData: provider.userData.createdAt != null
                      ? '${provider.userData.createdAt}'
                      : '',
                ),
              ),
              Container(
              ...
              provider.userData.colorList != null
                  ? Container(
                          ...
                          ? ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                return StringContent(
                                    content:
                                        provider.userData.colorList[index]);
                              })
                          : Container(
                              margin: EdgeInsets.only(
                                left: dimension.width * 0.04,
              ...
              provider.userData.countryList != null
                  ? Container(
                      height: dimension.height * 0.05,
                      child: provider.userData.countryList.length > 0
                          ? ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                return StringContent(
                                    content:
                                        provider.userData.countryList[index]);
                              })
                          : Container(
                              margin: EdgeInsets.only(
                                left: dimension.width * 0.04,
